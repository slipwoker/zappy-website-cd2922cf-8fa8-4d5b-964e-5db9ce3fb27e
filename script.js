    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "קהילת איתי בלב משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'cd2922cf-8fa8-4d5b-964e-5db9ce3fb27e',
                    name: data.name || '',
                    email: data.email || '',
